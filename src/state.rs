...
pub struct Oxide {
    ...
    pub seat_state: SeatState<Oxide>,
...
impl Oxide {
    pub fn new(event_loop: &mut EventLoop<Self>, display: Display<Self>) -> Self {
        ...
        // Some of them require us to implement traits on the Oxide state,
    ...
    fn init_wayland_listener(display: Display<Oxide>, event_loop: &mut EventLoop<Self>) -> OsString {
...
/// Data associated with a wayland client that connects to Oxide.
